    ...
    <div className="payment-summary">
      ...
      {paymentSummary && (
        <>
          ...
          <div className="payment-summary-row" data-testid="payment-summary-items">
          ...
          <div className="payment-summary-row subtotal-row" data-testid="payment-summary-subtotal">
